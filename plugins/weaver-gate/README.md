...
**Advisory contract.** Per [../enchanter-foundations/packages/core/conduct/hooks.md](../../../enchanter-foundations/packages/core/conduct/hooks.md): hooks inform, they don't decide. The hook always exits 0. Blocking semantics, when needed, live in a Skill the model invokes deliberately.
