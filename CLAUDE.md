...
- @../vis/packages/core/conduct/doubt-engine.md — adversarial self-check before agreement; F01 sycophancy counter
...
| W5 | Gauss Learning (Sylph) | sylph-learning | EMA update `new = α·signal + (1−α)·old`, α=0.3. Tracks commit style, branch-naming, PR turnaround, reviewer overrides, W2 threshold corrections per-developer. Bootstrap floor at 10 samples; below floor, priors are ignored. | Brown R.G. (1956) / Holt C.C. (1957), exponential smoothing; conjugate Beta-Binomial posterior; ecosystem precedent: Wixie F6, Emu A7, Crow H6, Djinn C5, Gorgon G5, Naga N5 |
