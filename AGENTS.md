...
- **doubt-engine.md** — `../vis/packages/core/conduct/doubt-engine.md` — adversarial self-check before agreement; F01 sycophancy counter
...
- **tier-sizing.md** — `../vis/packages/core/conduct/tier-sizing.md` — agent-tier budget allocation per task class
- **web-fetch.md** — `../vis/packages/web/conduct/web-fetch.md` — external-URL-handling hygiene
